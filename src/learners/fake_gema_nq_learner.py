...
class FakeGemaNQLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        goal_states = states.clone()
        kill_all_enemies = list(range(40, 75))
        goal_states[:, kill_all_enemies] = 0
        ...
        with torch.no_grad():
            ...
            similarity = torch.nn.functional.cosine_similarity(states, goal_states, dim=-1)
